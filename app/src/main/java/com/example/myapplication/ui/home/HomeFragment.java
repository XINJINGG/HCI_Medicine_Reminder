...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        medicineList.add(new Medicine("Amlodipine", "Blood pressure control",
                R.drawable.amlodipine, "1 hr", "Woodland Watson", 70));
        medicineList.add(new Medicine("Atorvastatin", "Cholesterol management",
                R.drawable.atorvastatin, "2 hrs", "Woodland Watson", 80));

        // Set up the MedicineAdapter with the click listener
        medicineAdapter = new MedicineAdapter(getContext(), medicineList, medicine -> {
            // Handle navigation when a medicine item is clicked
            Bundle bundle = new Bundle();
            bundle.putString("medicineName", medicine.getName());
            bundle.putString("medicinePurpose", medicine.getPurpose());
            Navigation.findNavController(root).navigate(R.id.action_navigation_home_to_medicineDetailsFragment, bundle);
        });
        ...
        missedMedicineList.add(new Medicine("Metformin", "Diabetes management",
                R.drawable.metformin, "1 hr ago", "Woodland Watson", 20));
        missedMedicineList.add(new Medicine("Aspirin", "Cardiovascular health",
                R.drawable.aspirin, "1 hr ago", "Woodland Watson", 20));

        missedMedicineAdapter = new MedicineAdapter(getContext(), missedMedicineList, medicine -> {
            // Handle navigation for missed medicine items if needed
            Bundle bundle = new Bundle();
            bundle.putString("medicineName", medicine.getName());
            bundle.putString("medicinePurpose", medicine.getPurpose());
            Navigation.findNavController(root).navigate(R.id.action_navigation_home_to_medicineDetailsFragment, bundle);
